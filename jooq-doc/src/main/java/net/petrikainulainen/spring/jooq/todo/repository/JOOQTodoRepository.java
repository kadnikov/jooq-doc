...
public class JOOQTodoRepository implements TodoRepository {
    ...
    public Todo add(Todo todoEntry) {
        ...
        TodosRecord persisted = jooq.insertInto(TODOS,TODOS.DESCRIPTION,TODOS.TITLE)
                .values(todoEntry.getDescription(),todoEntry.getTitle())
                .returning()
                .fetchOne();
    ...
    public Todo delete(Long id) {
        ...
        int deletedRecordCount = jooq.delete(TODOS)
                .where(TODOS.ID.equal(id.intValue()))
                .execute();
    ...
    public Todo update(Todo todoEntry) {
        ...
        int updatedRecordCount = jooq.update(TODOS)
                ...
                .where(TODOS.ID.equal(todoEntry.getId().intValue()))
                .execute();
